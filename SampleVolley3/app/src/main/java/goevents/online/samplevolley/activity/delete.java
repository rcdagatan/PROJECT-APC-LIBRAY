    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                Toast.makeText(delete.this, apcList.get(position).getID() +
                        " has been removed from the list.", Toast.LENGTH_SHORT).show();
                Log.d("debug",apcList.get(position).getID());
                loading = ProgressDialog.show(delete.this, null, "Loading...", true, true);
                loading.setCancelable(false);
                loading.show();
               CustomJsonRequest jsonReq = new CustomJsonRequest(Request.Method.POST, EndPoints.URL_DB_DEL_ALL,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                         ...
                         params.put("id", apcList.get(position).getID());
                        Log.d("debug", apcList.get(position).getID());
                        return params;
        ...
        CustomJsonRequest jsonReq = new CustomJsonRequest(Request.Method.GET, EndPoints.URL_DB_GET_ALL,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(delete.this, "Error parsing data", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(delete.this, "Can't reach database", Toast.LENGTH_SHORT).show();
                loading.cancel();
            }
...
//                return params;
    ...
    private void parseJsonFeed(JSONObject jsonObject) {
        ...
        try {
            ...
            adapter = new CustomListAdapter(delete.this, apcList);
